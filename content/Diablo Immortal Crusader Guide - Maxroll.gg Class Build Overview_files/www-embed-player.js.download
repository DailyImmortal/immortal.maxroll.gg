...
function vd(a){if(!Array.isArray(a))throw Error("cannot mark non-array as immutable");ld(a,2)}
...
function Pd(a,b,c,d){c=void 0===c?!0:c;var e=Od(a,b,d);Array.isArray(e)||(e=Ad);if(xd(a))c&&(vd(e),Object.freeze(e));else if(e===Ad||pd(e))e=od(e.slice()),E(a,b,e,d);return e}
...
function Ud(a,b,c,d,e){e=void 0===e?!1:e;var f=e;if(-1===c)d=null;else{a.i||(a.i={});var g=a.i[c];if(g)d=g;else{var h=Od(a,c,f);b=Gd(h,b,d);void 0==b?d=g:(d&&b.I!==h&&E(a,c,b.I,f,!0),a.i[c]=b,xd(a)&&vd(b.I),d=b)}}if(null==d)return d;xd(d)&&!xd(a)&&(d=d.Bb(Ec),E(a,c,d.I,e),a.i[c]=d);return d}
function Vd(a,b,c,d,e){e=void 0===e?!0:e;a.i||(a.i={});var f=xd(a),g=a.i[c];d=Pd(a,c,!0,d);var h=f||pd(d);if(!g){g=[];f=f||h;for(var k=0;k<d.length;k++){var m=d[k];f=f||pd(m);m=Gd(m,b);void 0!==m&&(g.push(m),h&&vd(m.I))}a.i[c]=g;wd(d,!f)}b=h||e;e=pd(g);b&&!e&&(Object.isFrozen(g)&&(a.i[c]=g=g.slice()),vd(g),Object.freeze(g));!b&&e&&(a.i[c]=g=g.slice());return g}
...
;function he(a,b,c,d,e,f){(a=a.i&&a.i[c])?Array.isArray(a)?(e=f.kb?od(a.slice()):a,Yd(b,0<e.length?e[0].constructor:void 0,c,e)):G(b,a.constructor,c,a):(gd&&d instanceof Uint8Array?e=d.length?new jd(new Uint8Array(d)):id||(id=new jd(null)):(Array.isArray(d)&&(e?vd(d):nd(d)&&f.kb&&(d=d.slice())),e=d),E(b,c,e))}
...
":"+ra);if("IGNORED"===a.level)var la=0;else a:{for(var qd=sr(),rd=p(qd.ma),xa=rd.next();!xa.done;xa=rd.next()){var jp=xa.value;if(H.message&&H.message.match(jp.pq)){la=jp.weight;break a}}for(var kp=p(qd.la),Rj=kp.next();!Rj.done;Rj=kp.next()){var lp=Rj.value;if(lp.callback(H)){la=lp.weight;break a}}la=1}H.sampleWeight=la;for(var mp=p(nr),Sj=mp.next();!Sj.done;Sj=mp.next()){var Tj=Sj.value;if(Tj.bb[H.name])for(var np=p(Tj.bb[H.name]),Uj=np.next();!Uj.done;Uj=np.next()){var op=Uj.value,Ig=H.message.match(op.regexp);
if(Ig){H.params["params.error.original"]=Ig[0];for(var Vj=op.groups,pp={},sd=0;sd<Vj.length;sd++)pp[Vj[sd]]=Ig[sd+1],H.params["params.error."+Vj[sd]]=Ig[sd+1];H.message=Tj.ub(pp);break}}}H.params||(H.params={});var qp=sr();H.params["params.errorServiceSignature"]="msg="+qp.ma.length+"&cb="+qp.la.length;H.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(H.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Fb("sample").constructor!==
...
Jj,Wj);fr(vp)}else{var wp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};P("report_client_error_with_app_crash_ks")||(wp.systemHealth={crashData:{clientError:{logMessage:{message:H.message}}}});em("appCrashed",wp)}Br++}else"WARNING"===h&&tr.oa("handleWarning",H);if(P("kevlar_gel_error_routing"))a:{var xe=h;if(P("errors_via_jspb")){if(Hr())var yp=void 0;else{var td=new Yi;E(td,1,H.stack);H.fileName&&E(td,4,H.fileName);var Db=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Db.length&&(1!==
Db.length||isNaN(Number(Db[0]))?2!==Db.length||isNaN(Number(Db[0]))||isNaN(Number(Db[1]))||(E(td,2,Number(Db[0])),E(td,3,Number(Db[1]))):E(td,2,Number(Db[0])));var vc=new aj;E(vc,1,H.message);E(vc,3,H.name);E(vc,6,H.sampleWeight);"ERROR"===xe?E(vc,2,2):"WARNING"===xe?E(vc,2,1):E(vc,2,0);var Xj=new Zi;E(Xj,1,!0);Xd(Xj,Yi,3,$i,td);var Yb=new Vi;E(Yb,3,window.location.href);for(var zp=M("FEXP_EXPERIMENTS",[]),Yj=0;Yj<zp.length;Yj++){var uv=zp[Yj];Bd(Yb);Pd(Yb,5).push(uv)}var Zj=M("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
...
Number(Eb[0]));var fk={level:"ERROR_LEVEL_UNKNOWN",message:H.message,errorClassName:H.name,sampleWeight:H.sampleWeight};"ERROR"===xe?fk.level="ERROR_LEVEL_ERROR":"WARNING"===xe&&(fk.level="ERROR_LEVEL_WARNNING");var vv={isObfuscated:!0,browserStackInfo:ye},ud={pageUrl:window.location.href,kvPairs:[]};M("FEXP_EXPERIMENTS")&&(ud.experimentIds=M("FEXP_EXPERIMENTS"));var gk=M("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!qk()&&gk)for(var Jp=p(Object.keys(gk)),xc=Jp.next();!xc.done;xc=Jp.next()){var Kp=
xc.value;ud.kvPairs.push({key:Kp,value:String(gk[Kp])})}var hk=H.params;if(hk){var Lp=p(Object.keys(hk));for(xc=Lp.next();!xc.done;xc=Lp.next()){var Mp=xc.value;ud.kvPairs.push({key:"client."+Mp,value:String(hk[Mp])})}}var Np=M("SERVER_NAME"),Op=M("SERVER_VERSION");Np&&Op&&(ud.kvPairs.push({key:"server.name",value:Np}),ud.kvPairs.push({key:"server.version",value:Op}));Ip={errorMetadata:ud,stackTrace:vv,logMessage:fk}}var Pp=Ip;if(!Pp)break a;em("clientError",Pp)}if("ERROR"===xe||P("errors_flush_gel_always_killswitch"))b:if(P("migrate_events_to_ts"))c:{if(P("web_fp_via_jspb")&&
...
;var Hs={identityType:"UNAUTHENTICATED_IDENTITY_TYPE_UNKNOWN"};var Is=new Map([["dark","USER_INTERFACE_THEME_DARK"],["light","USER_INTERFACE_THEME_LIGHT"]]);function Js(){var a=void 0===a?window.location.href:a;if(P("kevlar_disable_theme_param"))return null;mc(nc(5,a));try{var b=Kk(a).theme;return Is.get(b)||null}catch(c){}return null}
;function Ks(){this.i={};if(this.j=jl()){var a=lg.get("CONSISTENCY",void 0);a&&Ls(this,{encryptedTokenJarContents:a})}}
Ks.prototype.handleResponse=function(a,b){if(!b)throw Error("request needs to be passed into ConsistencyService");var c,d;b=(null==(c=b.ga.context)?void 0:null==(d=c.request)?void 0:d.consistencyTokenJars)||[];var e;if(a=null==(e=a.responseContext)?void 0:e.consistencyTokenJar){e=p(b);for(c=e.next();!c.done;c=e.next())delete this.i[c.value.encryptedTokenJarContents];Ls(this,a)}};
function Ls(a,b){if(b.encryptedTokenJarContents&&(a.i[b.encryptedTokenJarContents]=b,"string"===typeof b.expirationSeconds)){var c=Number(b.expirationSeconds);setTimeout(function(){delete a.i[b.encryptedTokenJarContents]},1E3*c);
a.j&&il("CONSISTENCY",b.encryptedTokenJarContents,c,void 0,!0)}}
;var Ms=window.location.hostname.split(".").slice(-2).join(".");function Ns(){var a=M("LOCATION_PLAYABILITY_TOKEN");"TVHTML5"===M("INNERTUBE_CLIENT_NAME")&&(this.i=Os(this))&&(a=this.i.get("yt-location-playability-token"));a&&(this.locationPlayabilityToken=a,this.j=void 0)}
var Ps;Ns.getInstance=function(){Ps=B("yt.clientLocationService.instance");Ps||(Ps=new Ns,z("yt.clientLocationService.instance",Ps));return Ps};
Ns.prototype.setLocationOnInnerTubeContext=function(a){a.client||(a.client={});this.j?(a.client.locationInfo||(a.client.locationInfo={}),a.client.locationInfo.latitudeE7=Math.floor(1E7*this.j.coords.latitude),a.client.locationInfo.longitudeE7=Math.floor(1E7*this.j.coords.longitude),a.client.locationInfo.horizontalAccuracyMeters=Math.round(this.j.coords.accuracy),a.client.locationInfo.forceLocationPlayabilityTokenRefresh=!0):this.locationPlayabilityToken&&(a.client.locationPlayabilityToken=this.locationPlayabilityToken)};
Ns.prototype.handleResponse=function(a){var b;a=null==(b=a.responseContext)?void 0:b.locationPlayabilityToken;void 0!==a&&(this.locationPlayabilityToken=a,this.j=void 0,"TVHTML5"===M("INNERTUBE_CLIENT_NAME")?(this.i=Os(this))&&this.i.set("yt-location-playability-token",a,15552E3):il("YT_CL",JSON.stringify({loctok:a}),15552E3,Ms,!0))};
function Os(a){return void 0===a.i?new Hl("yt-client-location"):a.i}
...
function Us(a){var b=void 0===b?"UNKNOWN_INTERFACE":b;if(1===a.length)return a[0];var c=Ts[b];if(c){var d=new RegExp(c),e=p(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,d.exec(c))return c}var f=[];Object.entries(Ts).forEach(function(g){var h=p(g);g=h.next().value;h=h.next().value;b!==g&&f.push(h)});
d=new RegExp(f.join("|"));a.sort(function(g,h){return g.length-h.length});
e=p(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,!d.exec(c))return c;return a[0]}
;function Vs(){}
Vs.prototype.o=function(a,b,c){b=void 0===b?{}:b;c=void 0===c?Hs:c;var d=a.clickTrackingParams,e=this.m,f=!1;f=void 0===f?!1:f;e=void 0===e?!1:e;var g=M("INNERTUBE_CONTEXT");if(g){g=wb(g);P("web_no_tracking_params_in_shell_killswitch")||delete g.clickTracking;g.client||(g.client={});var h=g.client;"MWEB"===h.clientName&&(h.clientFormFactor=M("IS_TABLET")?"LARGE_FORM_FACTOR":"SMALL_FORM_FACTOR");h.screenWidthPoints=window.innerWidth;h.screenHeightPoints=window.innerHeight;h.screenPixelDensity=Math.round(window.devicePixelRatio||
1);h.screenDensityFloat=window.devicePixelRatio||1;h.utcOffsetMinutes=-Math.floor((new Date).getTimezoneOffset());var k=void 0===k?!1:k;ll.getInstance();var m="USER_INTERFACE_THEME_LIGHT";ol(165)?m="USER_INTERFACE_THEME_DARK":ol(174)?m="USER_INTERFACE_THEME_LIGHT":!P("kevlar_legacy_browsers")&&window.matchMedia&&window.matchMedia("(prefers-color-scheme)").matches&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(m="USER_INTERFACE_THEME_DARK");k=k?m:Js()||m;h.userInterfaceTheme=k;if(!f){if(k=
...
fa.Object.defineProperties(Vs.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!1}}});function Ws(){}
t(Ws,Vs);Ws.prototype.o=function(){return{input:"/getDatasyncIdsEndpoint",Ba:ls("/getDatasyncIdsEndpoint","GET"),ga:{}}};
Ws.prototype.l=function(){return[]};
Ws.prototype.i=function(){};
Ws.prototype.j=function(){};var Xs={},Ys=(Xs.GET_DATASYNC_IDS=Rs(Ws),Xs);function Zs(a){var b=Ma.apply(1,arguments);if(!$s(a)||b.some(function(d){return!$s(d)}))throw Error("Only objects may be merged.");
b=p(b);for(var c=b.next();!c.done;c=b.next())at(a,c.value);return a}
function at(a,b){for(var c in b)if($s(b[c])){if(c in a&&!$s(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});at(a[c],b[c])}else if(bt(b[c])){if(c in a&&!bt(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);ct(a[c],b[c])}else a[c]=b[c];return a}
function ct(a,b){b=p(b);for(var c=b.next();!c.done;c=b.next())c=c.value,$s(c)?a.push(at({},c)):bt(c)?a.push(ct([],c)):a.push(c);return a}
function $s(a){return"object"===typeof a&&!Array.isArray(a)}
function bt(a){return"object"===typeof a&&Array.isArray(a)}
;function dt(a,b){Mn.call(this,1,arguments);this.timer=b}
t(dt,Mn);var et=new Nn("aft-recorded",dt);var ft=window;function gt(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var T=ft.performance||ft.mozPerformance||ft.msPerformance||ft.webkitPerformance||new gt;var ht=!1,jt={'script[name="scheduler/scheduler"]':"sj",'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'link[rel="stylesheet"][name="player/www-player"]':"pc",'script[name="desktop_polymer/desktop_polymer"]':"dpj",'link[rel="import"][name="desktop_polymer"]':"dph",'script[name="mobile-c3"]':"mcj",'link[rel="stylesheet"][name="mobile-c3"]':"mcc",'script[name="player-plasma-ias-phone/base"]':"mcppj",'script[name="player-plasma-ias-tablet/base"]':"mcptj",'link[rel="stylesheet"][name="mobile-polymer-player-ias"]':"mcpc",
'link[rel="stylesheet"][name="mobile-polymer-player-svg-ias"]':"mcpsc",'script[name="mobile_blazer_core_mod"]':"mbcj",'link[rel="stylesheet"][name="mobile_blazer_css"]':"mbc",'script[name="mobile_blazer_logged_in_users_mod"]':"mbliuj",'script[name="mobile_blazer_logged_out_users_mod"]':"mblouj",'script[name="mobile_blazer_noncore_mod"]':"mbnj","#player_css":"mbpc",'script[name="mobile_blazer_desktopplayer_mod"]':"mbpj",'link[rel="stylesheet"][name="mobile_blazer_tablet_css"]':"mbtc",'script[name="mobile_blazer_watch_mod"]':"mbwj"};
Za(T.clearResourceTimings||T.webkitClearResourceTimings||T.mozClearResourceTimings||T.msClearResourceTimings||T.oClearResourceTimings||eb,T);function kt(a){var b=lt(a);if(b.aft)return b.aft;a=M((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function mt(){var a;if(P("csi_use_performance_navigation_timing")||P("csi_use_performance_navigation_timing_tvhtml5")){var b,c,d,e=null==T?void 0:null==(a=T.getEntriesByType)?void 0:null==(b=a.call(T,"navigation"))?void 0:null==(c=b[0])?void 0:null==(d=c.toJSON)?void 0:d.call(c);e?(e.requestStart=nt(e.requestStart),e.responseEnd=nt(e.responseEnd),e.redirectStart=nt(e.redirectStart),e.redirectEnd=nt(e.redirectEnd),e.domainLookupEnd=nt(e.domainLookupEnd),e.connectStart=nt(e.connectStart),e.connectEnd=
nt(e.connectEnd),e.responseStart=nt(e.responseStart),e.secureConnectionStart=nt(e.secureConnectionStart),e.domainLookupStart=nt(e.domainLookupStart),e.isPerformanceNavigationTiming=!0,a=e):a=T.timing}else a=T.timing;return a}
function ot(){return(P("csi_use_time_origin")||P("csi_use_time_origin_tvhtml5"))&&T.timeOrigin?Math.floor(T.timeOrigin):T.timing.navigationStart}
function nt(a){return Math.round(ot()+a)}
function pt(a){var b;(b=B("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},z("ytcsi."+(a||"")+"data_",b));return b}
function qt(a){a=pt(a);a.info||(a.info={});return a.info}
function lt(a){a=pt(a);a.tick||(a.tick={});return a.tick}
function rt(a){a=pt(a);if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}else a.gel={gelTicks:{},gelInfos:{}};return a.gel}
function st(a){a=rt(a);a.gelInfos||(a.gelInfos={});return a.gelInfos}
function tt(a){var b=pt(a).nonce;b||(b=Nr(),pt(a).nonce=b);return b}
function ut(a){var b=lt(a||""),c=kt(a);c&&!ht&&(Sn(et,new dt(Math.round(c-b._start),a)),ht=!0)}
...
V.query="unpluggedInfo.query",V.upg_chip_ids_string="unpluggedInfo.upgChipIdsString",V.yt_vst="videoStreamType",V.vph="viewportHeight",V.vpw="viewportWidth",V.yt_vis="isVisible",V.rcl="mwebInfo.responseContentLength",V.GetSettings_rid="requestIds",V.GetTrending_rid="requestIds",V.GetMusicSearchSuggestions_rid="requestIds",V.REQUEST_ID="requestIds",V),Ct="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),
Dt={},Et=(Dt.ccs="CANARY_STATE_",Dt.mver="MEASUREMENT_VERSION_",Dt.pis="PLAYER_INITIALIZED_STATE_",Dt.yt_pt="LATENCY_PLAYER_",Dt.pa="LATENCY_ACTION_",Dt.ctop="TOP_ENTITY_TYPE_",Dt.yt_vst="VIDEO_STREAM_TYPE_",Dt),Ft="all_vc ap aq c cbr cbrand cbrver cmodel cos cosver cplatform ctheme cver ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function Gt(a){return At[a]||"LATENCY_ACTION_UNKNOWN"}
function Ht(a,b,c){c=rt(c);if(c.gelInfos)c.gelInfos[a]=!0;else{var d={};c.gelInfos=(d[a]=!0,d)}if(a.match("_rid")){var e=a.split("_rid")[0];a="REQUEST_ID"}if(a in Bt){c=Bt[a];0<=gb(Ct,c)&&(b=!!b);a in Et&&"string"===typeof b&&(b=Et[a]+b.toUpperCase());a=b;b=c.split(".");for(var f=d={},g=0;g<b.length-1;g++){var h=b[g];f[h]={};f=f[h]}f[b[b.length-1]]="requestIds"===c?[{id:a,endpoint:e}]:a;return Zs({},d)}0<=gb(Ft,a)||Gr(new S("Unknown label logged with GEL CSI",a))}
...
W[W.LATENCY_ACTION_HOME]="LATENCY_ACTION_HOME";W[W.LATENCY_ACTION_STARTUP]="LATENCY_ACTION_STARTUP";W[W.LATENCY_ACTION_UNKNOWN]="LATENCY_ACTION_UNKNOWN";var It={LATENCY_NETWORK_MOBILE:2,LATENCY_NETWORK_WIFI:1,LATENCY_NETWORK_UNKNOWN:0};It[It.LATENCY_NETWORK_MOBILE]="LATENCY_NETWORK_MOBILE";It[It.LATENCY_NETWORK_WIFI]="LATENCY_NETWORK_WIFI";It[It.LATENCY_NETWORK_UNKNOWN]="LATENCY_NETWORK_UNKNOWN";
...
Y[Y.DETAILED_NETWORK_TYPE_1_X_RTT]="DETAILED_NETWORK_TYPE_1_X_RTT";Y[Y.DETAILED_NETWORK_TYPE_GPRS]="DETAILED_NETWORK_TYPE_GPRS";Y[Y.DETAILED_NETWORK_TYPE_EDGE]="DETAILED_NETWORK_TYPE_EDGE";Y[Y.DETAILED_NETWORK_TYPE_UNKNOWN]="DETAILED_NETWORK_TYPE_UNKNOWN";var Jt={LATENCY_PLAYER_RTSP:7,LATENCY_PLAYER_HTML5_INLINE:6,LATENCY_PLAYER_HTML5_FULLSCREEN:5,LATENCY_PLAYER_HTML5:4,LATENCY_PLAYER_FRAMEWORK:3,LATENCY_PLAYER_FLASH:2,LATENCY_PLAYER_EXO:1,LATENCY_PLAYER_UNKNOWN:0};Jt[Jt.LATENCY_PLAYER_RTSP]="LATENCY_PLAYER_RTSP";
Jt[Jt.LATENCY_PLAYER_HTML5_INLINE]="LATENCY_PLAYER_HTML5_INLINE";Jt[Jt.LATENCY_PLAYER_HTML5_FULLSCREEN]="LATENCY_PLAYER_HTML5_FULLSCREEN";Jt[Jt.LATENCY_PLAYER_HTML5]="LATENCY_PLAYER_HTML5";Jt[Jt.LATENCY_PLAYER_FRAMEWORK]="LATENCY_PLAYER_FRAMEWORK";Jt[Jt.LATENCY_PLAYER_FLASH]="LATENCY_PLAYER_FLASH";Jt[Jt.LATENCY_PLAYER_EXO]="LATENCY_PLAYER_EXO";Jt[Jt.LATENCY_PLAYER_UNKNOWN]="LATENCY_PLAYER_UNKNOWN";
var Kt={LATENCY_AD_BREAK_TYPE_POSTROLL:3,LATENCY_AD_BREAK_TYPE_MIDROLL:2,LATENCY_AD_BREAK_TYPE_PREROLL:1,LATENCY_AD_BREAK_TYPE_UNKNOWN:0};Kt[Kt.LATENCY_AD_BREAK_TYPE_POSTROLL]="LATENCY_AD_BREAK_TYPE_POSTROLL";Kt[Kt.LATENCY_AD_BREAK_TYPE_MIDROLL]="LATENCY_AD_BREAK_TYPE_MIDROLL";Kt[Kt.LATENCY_AD_BREAK_TYPE_PREROLL]="LATENCY_AD_BREAK_TYPE_PREROLL";Kt[Kt.LATENCY_AD_BREAK_TYPE_UNKNOWN]="LATENCY_AD_BREAK_TYPE_UNKNOWN";var Lt={LATENCY_ACTION_ERROR_STARTUP_TIMEOUT:1,LATENCY_ACTION_ERROR_UNSPECIFIED:0};
Lt[Lt.LATENCY_ACTION_ERROR_STARTUP_TIMEOUT]="LATENCY_ACTION_ERROR_STARTUP_TIMEOUT";Lt[Lt.LATENCY_ACTION_ERROR_UNSPECIFIED]="LATENCY_ACTION_ERROR_UNSPECIFIED";var Mt={LIVE_STREAM_MODE_WINDOW:5,LIVE_STREAM_MODE_POST:4,LIVE_STREAM_MODE_LP:3,LIVE_STREAM_MODE_LIVE:2,LIVE_STREAM_MODE_DVR:1,LIVE_STREAM_MODE_UNKNOWN:0};Mt[Mt.LIVE_STREAM_MODE_WINDOW]="LIVE_STREAM_MODE_WINDOW";Mt[Mt.LIVE_STREAM_MODE_POST]="LIVE_STREAM_MODE_POST";Mt[Mt.LIVE_STREAM_MODE_LP]="LIVE_STREAM_MODE_LP";
Mt[Mt.LIVE_STREAM_MODE_LIVE]="LIVE_STREAM_MODE_LIVE";Mt[Mt.LIVE_STREAM_MODE_DVR]="LIVE_STREAM_MODE_DVR";Mt[Mt.LIVE_STREAM_MODE_UNKNOWN]="LIVE_STREAM_MODE_UNKNOWN";var Nt={VIDEO_STREAM_TYPE_VOD:3,VIDEO_STREAM_TYPE_DVR:2,VIDEO_STREAM_TYPE_LIVE:1,VIDEO_STREAM_TYPE_UNSPECIFIED:0};Nt[Nt.VIDEO_STREAM_TYPE_VOD]="VIDEO_STREAM_TYPE_VOD";Nt[Nt.VIDEO_STREAM_TYPE_DVR]="VIDEO_STREAM_TYPE_DVR";Nt[Nt.VIDEO_STREAM_TYPE_LIVE]="VIDEO_STREAM_TYPE_LIVE";Nt[Nt.VIDEO_STREAM_TYPE_UNSPECIFIED]="VIDEO_STREAM_TYPE_UNSPECIFIED";
var Ot={YT_IDB_TRANSACTION_TYPE_READ:2,YT_IDB_TRANSACTION_TYPE_WRITE:1,YT_IDB_TRANSACTION_TYPE_UNKNOWN:0};Ot[Ot.YT_IDB_TRANSACTION_TYPE_READ]="YT_IDB_TRANSACTION_TYPE_READ";Ot[Ot.YT_IDB_TRANSACTION_TYPE_WRITE]="YT_IDB_TRANSACTION_TYPE_WRITE";Ot[Ot.YT_IDB_TRANSACTION_TYPE_UNKNOWN]="YT_IDB_TRANSACTION_TYPE_UNKNOWN";var Pt={PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN:2,PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT:1,PLAYER_ROTATION_TYPE_UNKNOWN:0};Pt[Pt.PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN]="PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN";
Pt[Pt.PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT]="PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT";Pt[Pt.PLAYER_ROTATION_TYPE_UNKNOWN]="PLAYER_ROTATION_TYPE_UNKNOWN";var Qt="actionVisualElement spinnerInfo resourceInfo playerInfo commentInfo mdxInfo watchInfo thumbnailLoadInfo creatorInfo unpluggedInfo reelInfo subscriptionsFeedInfo requestIds mediaBrowserActionInfo musicLoadActionInfo shoppingInfo prefetchInfo accelerationSession webInfo tvInfo kabukiInfo mwebInfo musicInfo".split(" ");var Rt=y.ytLoggingLatencyUsageStats_||{};z("ytLoggingLatencyUsageStats_",Rt);function St(){this.i=0}
function Tt(){St.i||(St.i=new St);return St.i}
St.prototype.tick=function(a,b,c,d){Ut(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},P("web_csi_via_jspb")?(d=new Fj,E(d,1,a),E(d,2,b),a=new Ij,Xd(a,Fj,5,Jj,d),fr(a,c)):em("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
St.prototype.info=function(a,b,c){var d=Object.keys(a).join("");Ut(this,"info_"+d+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,em("latencyActionInfo",a,{cttAuthInfo:c}))};
St.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));Ut(this,"info_"+d+"_"+b)||(E(a,2,b),b={cttAuthInfo:c},c=new Ij,Xd(c,zj,7,Jj,a),fr(c,b))};
St.prototype.span=function(a,b,c){var d=Object.keys(a).join("");Ut(this,"span_"+d+"_"+b)||(a.clientActionNonce=b,em("latencyActionSpan",a,{cttAuthInfo:c}))};
function Ut(a,b){Rt[b]=Rt[b]||{count:0};var c=Rt[b];c.count++;c.time=R();a.i||(a.i=Ql(function(){var d=R(),e;for(e in Rt)Rt[e]&&6E4<d-Rt[e].time&&delete Rt[e];a&&(a.i=0)},0,5E3));
...
;function Vt(){var a=["ol"];zt("").info.actionType="embed";a&&pk("TIMING_AFT_KEYS",a);pk("TIMING_ACTION","embed");Wt();a=qt();var b=st();if("cold"===a.yt_lt||"cold"===b.loadType){var c=lt(),d=rt();d=d.gelTicks?d.gelTicks:d.gelTicks={};for(var e in c)e in d||Z(e,c[e]);e={};c=!1;d=p(Object.keys(a));for(var f=d.next();!f.done;f=d.next())f=f.value,(f=Ht(f,a[f]))&&!vt(st(),f)&&(Zs(b,f),Zs(e,f),c=!0);c&&Xt(e)}z("ytglobal.timingready_",!0);a=M("TIMING_ACTION");B("ytglobal.timingready_")&&a&&"_start"in lt()&&
kt()&&ut()}
function Yt(a,b,c,d){null!==b&&(qt(c)[a]=b,(a=Ht(a,b,c))&&Xt(a,c,d))}
function Xt(a,b,c){if(!P("web_csi_via_jspb")||(void 0===c?0:c))c=zt(b||""),Zs(c.info,a),Zs(st(b),a),c=tt(b),b=pt(b).cttAuthInfo,Tt().info(a,c,b);else{c=new zj;var d=Object.keys(a);a=Object.values(a);for(var e=0;e<d.length;e++){var f=d[e];try{switch(f){case "actionType":Bj(c,W[a[e]]);break;case "clientActionNonce":E(c,2,a[e]);break;case "clientScreenNonce":E(c,4,a[e]);break;case "loadType":E(c,3,a[e]);break;case "isPrewarmedLaunch":E(c,92,a[e]);break;case "isFirstInstall":E(c,55,a[e]);break;case "networkType":E(c,
5,It[a[e]]);break;case "connectionType":E(c,26,X[a[e]]);break;case "detailedConnectionType":E(c,27,Y[a[e]]);break;case "isVisible":E(c,6,a[e]);break;case "playerType":E(c,7,Jt[a[e]]);break;case "clientPlaybackNonce":E(c,8,a[e]);break;case "adClientPlaybackNonce":E(c,28,a[e]);break;case "previousCpn":E(c,77,a[e]);break;case "targetCpn":E(c,76,a[e]);break;case "isMonetized":E(c,9,a[e]);break;case "isPrerollAllowed":E(c,16,a[e]);break;case "isPrerollShown":E(c,17,a[e]);break;case "adType":E(c,12,a[e]);
break;case "adTypesAllowed":E(c,36,a[e]);break;case "adNetworks":E(c,37,a[e]);break;case "previousAction":E(c,13,W[a[e]]);break;case "isRedSubscriber":E(c,14,a[e]);break;case "serverTimeMs":E(c,15,a[e]);break;case "videoId":c.setVideoId(a[e]);break;case "adVideoId":E(c,20,a[e]);break;case "targetVideoId":E(c,78,a[e]);break;case "adBreakType":E(c,21,Kt[a[e]]);break;case "isNavigation":Cj(c,a[e]);break;case "viewportHeight":E(c,29,a[e]);break;case "viewportWidth":E(c,30,a[e]);break;case "screenHeight":E(c,
...
case "appInstallDataAgeMs":E(c,73,a[e]);break;case "latencyActionError":E(c,71,Lt[a[e]]);break;case "actionStep":E(c,79,a[e]);break;case "jsHeapSizeLimit":E(c,80,a[e]);break;case "totalJsHeapSize":E(c,81,a[e]);break;case "usedJsHeapSize":E(c,82,a[e]);break;case "sourceVideoDurationMs":E(c,90,a[e]);break;case "videoOutputFrames":E(c,93,a[e]);break;case "isResume":E(c,104,a[e]);break;case "adPrebufferedTimeSecs":E(c,39,a[e]);break;case "isLivestream":E(c,47,a[e]);break;case "liveStreamMode":E(c,91,
Mt[a[e]]);break;case "adCpn2":E(c,48,a[e]);break;case "adDaiDriftMillis":E(c,49,a[e]);break;case "videoStreamType":E(c,53,Nt[a[e]]);break;case "playbackRequiresTap":E(c,56,a[e]);break;case "performanceNavigationTiming":E(c,67,a[e]);break;case "transactionType":E(c,74,Ot[a[e]]);break;case "playerRotationType":E(c,101,Pt[a[e]]);break;case "allowedPreroll":E(c,10,a[e]);break;case "shownPreroll":E(c,11,a[e]);break;case "getHomeRequestId":E(c,57,a[e]);break;case "getSearchRequestId":E(c,60,a[e]);break;
case "getPlayerRequestId":E(c,61,a[e]);break;case "getWatchNextRequestId":E(c,62,a[e]);break;case "getBrowseRequestId":E(c,63,a[e]);break;case "getLibraryRequestId":E(c,66,a[e]);break;default:Qt.includes(f)&&yk(new S("Codegen laipb translator asked to translate message field",""+f))}}catch(g){yk(Error("Codegen laipb translator failed to set "+f))}}Zt(c,b)}}
function Zt(a,b){var c=rt(b);c.jspbInfos||(c.jspbInfos=[]);c.jspbInfos.push(a);zt(b||"").jspbInfo.push(a);c=tt(b);b=pt(b).cttAuthInfo;Tt().jspbInfo(a,c,b)}
function Z(a,b,c){if(!b&&"_"!==a[0]){var d=a;T.mark&&(0==d.lastIndexOf("mark_",0)||(d="mark_"+d),c&&(d+=" ("+c+")"),T.mark(d))}d=zt(c||"");d.tick[a]=b||R();if(d.callback&&d.callback[a]){d=p(d.callback[a]);for(var e=d.next();!e.done;e=d.next())e=e.value,e()}d=rt(c);d.gelTicks&&(d.gelTicks[a]=!0);d=lt(c);e=b||R();d[a]=e;e=tt(c);var f=pt(c).cttAuthInfo;if("_start"===a){var g=Tt();Ut(g,"baseline_"+e)||(b={timestamp:b,cttAuthInfo:f},P("web_csi_via_jspb")?(f=new xj,E(f,1,e),e=new Ij,Xd(e,xj,6,Jj,f),fr(e,
b)):em("latencyActionBaselined",{clientActionNonce:e},b))}else Tt().tick(a,e,b,f);ut(c);return d[a]}
function $t(){var a=tt();requestAnimationFrame(function(){setTimeout(function(){a===tt()&&Z("ol",void 0,void 0)},0)})}
function au(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=hp+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
function Wt(){function a(f){var g=mt(),h=ot(),k=M("CSI_START_TIMESTAMP_MILLIS",0);0<k&&!P("embeds_web_enable_csi_start_override_killswitch")&&(h=k);h&&(Z("srt",g.responseStart),1!==f.prerender&&Z("_start",h,void 0));f=wt();0<f&&Z("fpt",f);f=mt();f.isPerformanceNavigationTiming&&Xt({performanceNavigationTiming:!0});Z("nreqs",f.requestStart,void 0);Z("nress",f.responseStart,void 0);Z("nrese",f.responseEnd,void 0);0<f.redirectEnd-f.redirectStart&&(Z("nrs",f.redirectStart,void 0),Z("nre",f.redirectEnd,
void 0));0<f.domainLookupEnd-f.domainLookupStart&&(Z("ndnss",f.domainLookupStart,void 0),Z("ndnse",f.domainLookupEnd,void 0));0<f.connectEnd-f.connectStart&&(Z("ntcps",f.connectStart,void 0),Z("ntcpe",f.connectEnd,void 0));f.secureConnectionStart>=ot()&&0<f.connectEnd-f.secureConnectionStart&&(Z("nstcps",f.secureConnectionStart,void 0),Z("ntcpe",f.connectEnd,void 0));T&&"getEntriesByType"in T&&bu()}
var b=M("TIMING_INFO",{});if(P("web_csi_via_jspb")){b=cu(b);Zt(b);b=Bj(Cj(new zj,!0),W[Gt(M("TIMING_ACTION"))]);var c=M("PREVIOUS_ACTION");c&&E(b,13,W[Gt(c)]);(c=M("CLIENT_PROTOCOL"))&&E(b,33,c);(c=M("CLIENT_TRANSPORT"))&&E(b,34,c);(c=Yr())&&"UNDEFINED_CSN"!==c&&E(b,4,c);c=au();1!==c&&-1!==c||E(b,6,!0);c=qt();E(b,3,"cold");a(c);c=du();if(0<c.length){c=p(c);for(var d=c.next();!d.done;d=c.next()){d=d.value;var e=new yj;E(e,1,d);Zd(b,83,yj,e)}}Zt(b)}else{for(c in b)b.hasOwnProperty(c)&&Yt(c,b[c]);b=
{isNavigation:!0,actionType:Gt(M("TIMING_ACTION"))};if(c=M("PREVIOUS_ACTION"))b.previousAction=Gt(c);if(c=M("CLIENT_PROTOCOL"))b.httpProtocol=c;if(c=M("CLIENT_TRANSPORT"))b.transportProtocol=c;(c=Yr())&&"UNDEFINED_CSN"!==c&&(b.clientScreenNonce=c);c=au();if(1===c||-1===c)b.isVisible=!0;c=qt();b.loadType="cold";a(c);c=du();if(0<c.length)for(b.resourceInfo=[],c=p(c),d=c.next();!d.done;d=c.next())b.resourceInfo.push({resourceCache:d.value});Xt(b)}}
function cu(a){var b=new zj;a=p(Object.entries(a));for(var c=a.next();!c.done;c=a.next()){var d=p(c.value);c=d.next().value;d=d.next().value;switch(c){case "GetBrowse_rid":var e=new Ej;E(e,1,c);E(e,2,String(d));Dj(b,e);break;case "GetGuide_rid":e=new Ej;E(e,1,c);E(e,2,String(d));Dj(b,e);break;case "GetHome_rid":e=new Ej;E(e,1,c);E(e,2,String(d));Dj(b,e);break;case "GetPlayer_rid":e=new Ej;E(e,1,c);E(e,2,String(d));Dj(b,e);break;case "GetSearch_rid":e=new Ej;E(e,1,c);E(e,2,String(d));Dj(b,e);break;
...
function eu(a,b){a=document.querySelector(a);if(!a)return!1;var c="",d=a.nodeName;"SCRIPT"===d?(c=a.src,c||(c=a.getAttribute("data-timing-href"))&&(c=window.location.protocol+c)):"LINK"===d&&(c=a.href);ic()&&a.setAttribute("nonce",ic());return c?(a=T.getEntriesByName(c))&&a[0]&&(a=a[0],c=ot(),Z("rsf_"+b,c+Math.round(a.fetchStart)),Z("rse_"+b,c+Math.round(a.responseEnd)),void 0!==a.transferSize&&0===a.transferSize)?!0:!1:!1}
function du(){var a=[];if(document.querySelector&&T&&T.getEntriesByName)for(var b in jt)if(jt.hasOwnProperty(b)){var c=jt[b];eu(b,c)&&a.push(c)}return a}
function bu(){var a=window.location.protocol,b=T.getEntriesByType("resource");b=ib(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
(b=kb(b,function(c,d){return d.duration>c.duration?d:c},{duration:0}))&&0<b.startTime&&0<b.responseEnd&&(Z("wffs",nt(b.startTime)),Z("wffe",nt(b.responseEnd)))}
var fu=window;fu.ytcsi&&(fu.ytcsi.info=Yt,fu.ytcsi.tick=Z);var gu="tokens consistency mss client_location entities response_received_commands store PLAYER_PRELOAD".split(" "),hu=["type.googleapis.com/youtube.api.pfiinnertube.YoutubeApiInnertube.BrowseResponse"];function iu(a,b,c,d){this.o=a;this.M=b;this.m=c;this.l=d;this.j=void 0;this.i=new Map;a.La||(a.La={});a.La=Object.assign({},Ys,a.La)}
function ju(a,b,c,d){if(void 0!==iu.i){if(d=iu.i,a=[a!==d.o,b!==d.M,c!==d.m,!1,!1,void 0!==d.j],a.some(function(e){return e}))throw new S("InnerTubeTransportService is already initialized",a);
}else iu.i=new iu(a,b,c,d)}
function ku(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?Hs:c;var d=Qs(b,a.o);if(!d)return yf(new S("Error: No request builder found for command.",b));var e=d.o(b,void 0,c);return e?new tf(function(f){var g,h,k;return w(function(m){if(1==m.i){h="cors"===(null==(g=e.Ba)?void 0:g.mode)?"cors":void 0;if(a.m.ld){var q=e.config,r;q=null==q?void 0:null==(r=q.Ra)?void 0:r.sessionIndex;r=xs({sessionIndex:q});k=Object.assign({},lu(h),r);return m.u(2)}return v(m,mu(e.config,
h),3)}2!=m.i&&(k=m.j);f(nu(a,e,k));m.i=0})}):yf(new S("Error: Failed to build request for command.",b))}
function nu(a,b,c){var d,e,f,g,h,k,m,q,r,x,u,A,D,F,N,O,Q,ca,aa,ja,ma,na,H,ra,la,qd,rd;return w(function(xa){switch(xa.i){case 1:xa.u(2);break;case 3:if((d=xa.j)&&!d.isExpired())return xa.return(Promise.resolve(d.i()));case 2:if(null==(e=b)?0:null==(f=e.ga)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.rq(b.ga.context);if(null==(m=a.j)?0:m.yq(b.input,b.ga))return xa.return(a.j.oq(b.input,b.ga));(x=null==(r=b.config)?void 0:r.Aa)&&a.i.has(x)&&P("web_memoize_inflight_requests")?q=
...
return v(xa,q,4);case 4:N=xa.j;if(P("web_one_platform_error_handling")&&(null==(O=N)?0:null==(Q=O.error)?0:Q.details))for(ca=N.error.details,aa=p(ca),ja=aa.next();!ja.done;ja=aa.next())ma=ja.value,(na=ma["@type"])&&-1<hu.indexOf(na)&&(delete ma["@type"],N=ma);x&&a.i.has(x)&&a.i.delete(x);(null==(H=b.config)?0:H.Xc)&&Z(b.config.Xc);if(N||null==(ra=a.j)||!ra.iq(b.input,b.ga)){xa.u(5);break}return v(xa,a.j.nq(b.input,b.ga),6);case 6:N=xa.j;case 5:if(N&&(null==(la=N.xq)||!la.Aq)&&a.l)for(qd=p(gu),h=qd.next();!h.done;h=
qd.next())rd=h.value,a.l[rd]&&a.l[rd].handleResponse(N,b);return xa.return(N)}})}
function mu(a,b){var c,d,e,f;return w(function(g){if(1==g.i){e=null==(c=a)?void 0:null==(d=c.Ra)?void 0:d.sessionIndex;var h=xs({sessionIndex:e});if(!(h instanceof tf)){var k=new tf(eb);uf(k,2,h);h=k}return v(g,h,2)}f=g.j;return g.return(Promise.resolve(Object.assign({},lu(b),f)))})}
function lu(a){var b={"Content-Type":"application/json"};P("enable_web_eom_visitor_data")&&M("EOM_VISITOR_DATA")?b["X-Goog-EOM-Visitor-Id"]=M("EOM_VISITOR_DATA"):M("VISITOR_DATA")&&(b["X-Goog-Visitor-Id"]=M("VISITOR_DATA"));P("track_webfe_innertube_auth_mismatch")&&(b["X-Youtube-Bootstrap-Logged-In"]=M("LOGGED_IN",!1));"cors"!==a&&((a=M("INNERTUBE_CONTEXT_CLIENT_NAME"))&&(b["X-Youtube-Client-Name"]=a),(a=M("INNERTUBE_CONTEXT_CLIENT_VERSION"))&&(b["X-Youtube-Client-Version"]=a),(a=M("CHROME_CONNECTED_HEADER"))&&
(b["X-Youtube-Chrome-Connected"]=a),(a=M("DOMAIN_ADMIN_STATE"))&&(b["X-Youtube-Domain-Admin-State"]=a));return b}
;var ou=new zs("INNERTUBE_TRANSPORT_TOKEN");var pu=["share/get_web_player_share_panel"],qu=["feedback"],ru=["notification/modify_channel_preference"],su=["browse/edit_playlist"],tu=["subscription/subscribe"],uu=["subscription/unsubscribe"];function vu(){}
t(vu,Vs);vu.prototype.l=function(){return tu};
...
t(wu,Vs);wu.prototype.l=function(){return uu};
...
t(xu,Vs);xu.prototype.l=function(){return qu};
...
t(yu,Vs);yu.prototype.l=function(){return ru};
...
t(zu,Vs);zu.prototype.l=function(){return su};
...
t(Au,Vs);Au.prototype.l=function(){return pu};
Au.prototype.i=function(a){return a.webPlayerShareEntityServiceEndpoint};
Au.prototype.j=function(a,b,c){c=void 0===c?{}:c;b.serializedShareEntity&&(a.serializedSharedEntity=b.serializedShareEntity);c.includeListId&&(a.includeListId=!0)};var Bs=new zs("NETWORK_SLI_TOKEN");function Bu(a){this.i=a}
...
return b};
Bu[ys]=[new As];var Cu=new zs("NETWORK_MANAGER_TOKEN");var Du;function Eu(a){Mn.call(this,1,arguments);this.csn=a}
t(Eu,Mn);var Vn=new Nn("screen-created",Eu),Fu=[],Hu=Gu,Iu=0;function Ju(a,b,c,d,e,f,g){function h(){Gr(new S("newScreen() parent element does not have a VE - rootVe",b))}
var k=Hu();f=new Rr({veType:b,youtubeData:f,jspbYoutubeData:void 0});e={cttAuthInfo:e,ba:k};if(P("il_via_jspb")){var m=new mj;m.V(k);nj(m,f.getAsJspb());c&&c.visualElement?(f=new oj,c.clientScreenNonce&&E(f,2,c.clientScreenNonce),pj(f,c.visualElement.getAsJspb()),g&&E(f,4,Kj[g]),G(m,oj,5,f)):c&&h();d&&E(m,3,d);kr(m,e,a)}else f={csn:k,pageVe:f.getAsJson()},c&&c.visualElement?(f.implicitGesture={parentCsn:c.clientScreenNonce,gesturedVe:c.visualElement.getAsJson()},g&&(f.implicitGesture.gestureType=
g)):c&&h(),d&&(f.cloneCsn=d),a?ar("screenCreated",f,a,e):em("screenCreated",f,e);Sn(Vn,new Eu(k));return k}
function Ku(a,b,c,d){var e=d.filter(function(k){k.csn!==b?(k.csn=b,k=!0):k=!1;return k}),f={cttAuthInfo:$r(b),
...
"UNDEFINED_CSN"==b?Lu("visualElementAttached",h,f):lr(h,f,a)}else c={csn:b,parentVe:c.getAsJson(),childVes:jb(e,function(k){return k.getAsJson()})},"UNDEFINED_CSN"==b?Lu("visualElementAttached",c,f):a?ar("visualElementAttached",c,a,f):em("visualElementAttached",c,f)}
function Gu(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return fd(b,3)}
function Lu(a,b,c){Fu.push({payloadName:a,payload:b,options:c});Iu||(Iu=Wn())}
function Xn(a){if(Fu){for(var b=p(Fu),c=b.next();!c.done;c=b.next())if(c=c.value,c.payload)if(P("il_via_jspb"))switch(c.payload.V(a.csn),c.payloadName){case "screenCreated":kr(c.payload,c.options);break;case "visualElementAttached":lr(c.payload,c.options);break;case "visualElementShown":gr(c.payload,c.options);break;case "visualElementHidden":hr(c.payload,c.options);break;case "visualElementGestured":ir(c.payload,c.options);break;case "visualElementStateChanged":jr(c.payload,c.options);break;default:Gr(new S("flushQueue unable to map payloadName to JSPB setter"))}else c.payload.csn=
a.csn,ar(c.payloadName,c.payload,null,c.options);Fu.length=0}Iu=0}
...
Qa(Mu);function Nu(){this.o=[];this.N=[];this.i=[];this.m=[];this.B=[];this.j=new Set;this.v=new Map}
Nu.prototype.s=function(a){this.client=a};
function Ou(a,b,c){c=void 0===c?0:c;b.then(function(d){a.j.has(c)&&a.l&&a.l();var e=Yr(c),f=Wr(c);if(e&&f){var g;(null==d?0:null==(g=d.response)?0:g.trackingParams)&&Ku(a.client,e,f,[Sr(d.response.trackingParams)]);var h;(null==d?0:null==(h=d.playerResponse)?0:h.trackingParams)&&Ku(a.client,e,f,[Sr(d.playerResponse.trackingParams)])}})}
function Pu(a,b,c,d){d=void 0===d?0:d;if(a.j.has(d))a.o.push([b,c]);else{var e=Yr(d);c=c||Wr(d);e&&c&&Ku(a.client,e,c,[b])}}
Nu.prototype.clickCommand=function(a,b,c){var d=a.clickTrackingParams;c=void 0===c?0:c;if(d)if(c=Yr(void 0===c?0:c)){a=this.client;var e=Sr(d);d={cttAuthInfo:$r(c),ba:c};if(P("il_via_jspb")){var f=new tj;f.V(c);e=e.getAsJspb();G(f,hj,2,e);E(f,4,Kj.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK);b&&G(f,kj,3);"UNDEFINED_CSN"==c?Lu("visualElementGestured",f,d):ir(f,d,a)}else f={csn:c,ve:e.getAsJson(),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"},b&&(f.clientData=b),"UNDEFINED_CSN"==c?
Lu("visualElementGestured",f,d):a?ar("visualElementGestured",f,a,d):em("visualElementGestured",f,d);b=!0}else b=!1;else b=!1;return b};
function Qu(a,b,c){c=void 0===c?{}:c;a.j.add(c.layer||0);a.l=function(){Ru(a,b,c);var f=Wr(c.layer);if(f){for(var g=p(a.o),h=g.next();!h.done;h=g.next())h=h.value,Pu(a,h[0],h[1]||f,c.layer);f=p(a.N);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=Yr(g);var m=k[0]||Wr(g);if(h&&m){g=a.client;var q=k[1];k={cttAuthInfo:$r(h),ba:h};P("il_via_jspb")?(q=new wj,q.V(h),m=m.getAsJspb(),G(q,hj,2,m),"UNDEFINED_CSN"==h?Lu("visualElementStateChanged",q,k):jr(q,k,g)):(m={csn:h,ve:m.getAsJson(),
clientData:q},"UNDEFINED_CSN"==h?Lu("visualElementStateChanged",m,k):g?ar("visualElementStateChanged",m,g,k):em("visualElementStateChanged",m,k))}}}};
Yr(c.layer)||a.l();if(c.Ob)for(var d=p(c.Ob),e=d.next();!e.done;e=d.next())Ou(a,e.value,c.layer);else Fr(Error("Delayed screen needs a data promise."))}
function Ru(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.Sc?c.Sc:c.layer;var e=Yr(d);d=Wr(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=M("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=Ju(a.client,b,f,c.Nb,c.cttAuthInfo,g,c.lq)}catch(m){Ir(m,{uq:b,rootVe:d,parentVisualElement:void 0,jq:e,qq:f,Nb:c.Nb});Fr(m);return}as(k,b,
c.layer,c.cttAuthInfo);if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=p(Object.values(Qr));for(f=b.next();!f.done;f=b.next())if(Yr(f.value)===e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:$r(e),ba:e,Pb:g},P("il_via_jspb")?(h=new uj,h.V(e),d=d.getAsJspb(),G(h,hj,2,d),E(h,4,g?16:8),"UNDEFINED_CSN"==e?Lu("visualElementHidden",h,f):hr(h,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"==e?Lu("visualElementHidden",d,f):b?ar("visualElementHidden",d,b,f):em("visualElementHidden",
d,f)));a.i[a.i.length-1]&&!a.i[a.i.length-1].csn&&(a.i[a.i.length-1].csn=k||"");Xt({clientScreenNonce:k});Mu.getInstance().clear();d=Wr(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(P("web_mark_root_visible")||P("music_web_mark_root_visible"))&&(e=k,k={cttAuthInfo:$r(e),ba:e},P("il_via_jspb")?(b=new vj,b.V(e),f=d.getAsJspb(),G(b,hj,2,f),E(b,4,1),"UNDEFINED_CSN"==e?Lu("visualElementShown",b,k):gr(b,k)):(b={csn:e,ve:d.getAsJson(),eventType:1},"UNDEFINED_CSN"==e?Lu("visualElementShown",b,k):em("visualElementShown",
b,k)));a.j.delete(c.layer||0);a.l=void 0;e=p(a.v);for(k=e.next();!k.done;k=e.next())b=p(k.value),k=b.next().value,b=b.next().value,b.has(c.layer)&&d&&Pu(a,k,d,c.layer);for(c=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(m){Fr(m)}}for(c=a.m.length=0;c<a.B.length;c++){e=a.B[c];try{e()}catch(m){Fr(m)}}}
;function Su(){var a,b;return w(function(c){if(1==c.i)return a=Gs().resolve(ou),a?v(c,ku(a),2):(Gr(Error("InnertubeTransportService unavailable in fetchDatasyncIds")),c.return(void 0));if(b=c.j)return b.errorMetadata?(Gr(Error("Datasync IDs fetch responded with "+b.errorMetadata.status+": "+b.error)),c.return(void 0)):c.return(b.kq);Gr(Error("Network request to get Datasync IDs failed."));return c.return(void 0)})}
;var Tu=y.caches,Uu;function Vu(a){var b=a.indexOf(":");return-1===b?{Zb:a}:{Zb:a.substring(0,b),datasyncId:a.substring(b+1)}}
function Wu(){return w(function(a){if(void 0!==Uu)return a.return(Uu);Uu=new Promise(function(b){var c;return w(function(d){switch(d.i){case 1:return Ba(d,2),v(d,Tu.open("test-only"),4);case 4:return v(d,Tu.delete("test-only"),5);case 5:Ca(d,3);break;case 2:if(c=Da(d),c instanceof Error&&"SecurityError"===c.name)return b(!1),d.return();case 3:b("caches"in window),d.i=0}})});
return a.return(Uu)})}
...
function Yu(){var a,b,c,d,e,f,g;return w(function(h){if(1==h.i)return v(h,Wu(),2);if(3!=h.i){if(!h.j)return h.return(!1);a=im("cache contains other");return v(h,Tu.keys(),3)}b=h.j;c=p(b);for(d=c.next();!d.done;d=c.next())if(e=d.value,f=Vu(e),(g=f.datasyncId)&&g!==a)return h.return(!0);return h.return(!1)})}
...
function bv(){if(!Zu())return!1;var a=im(),b=Object.keys(window.localStorage);b=p(b);for(var c=b.next();!c.done;c=b.next())if(c=$u(c.value),void 0!==c&&c!==a)return!0;return!1}
;function cv(){Su().then(function(a){a&&(tn(a),Xu(a),av(a))})}
function dv(){var a=new Do;Qh.S(function(){var b,c,d,e;return w(function(f){switch(f.i){case 1:if(P("ytidb_clear_optimizations_killswitch")){f.u(2);break}b=im("clear");if(b.startsWith("V")){var g=[b];tn(g);Xu(g);av(g);return f.return()}c=bv();return v(f,Yu(),3);case 3:return d=f.j,v(f,un(),4);case 4:if(e=f.j,!c&&!d&&!e)return f.return();case 2:a.L()?cv():a.m.add("publicytnetworkstatus-online",cv,!0,void 0,void 0),f.i=0}})})}
...
function lv(a,b,c){c=void 0===c?null:c;var d=mv(a),e=document.getElementById(d),f=e&&gv(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=mq(d,b),b=""+Ua(b),nv[b]=f),g||(e=ov(a,d,function(){gv(e,"loaded")||(ev(e),pq(d),Sk($a(qq,d),0))},c)))}
function ov(a,b,c,d){d=void 0===d?null:d;var e=ef("SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function pv(a){a=mv(a);var b=document.getElementById(a);b&&(qq(a),b.parentNode.removeChild(b))}
function qv(a,b){a&&b&&(a=""+Ua(b),(a=nv[a])&&oq(a))}
function mv(a){var b=document.createElement("a");fc(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+kc(a)}
var nv={};var rv=[],sv=!1;function tv(){if(!P("disable_biscotti_fetch_for_ad_blocker_detection")&&!P("disable_biscotti_fetch_entirely_for_all_web_clients")&&ms()){var a=M("PLAYER_VARS",{});if("1"!=tb(a)&&!ns(a)){var b=function(){sv=!0;"google_ad_status"in window?pk("DCLKSTAT",1):pk("DCLKSTAT",2)};
try{kv("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}rv.push(Qh.S(function(){if(!(sv||"google_ad_status"in window)){try{qv("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}sv=!0;pk("DCLKSTAT",3)}},5E3))}}}
function wv(){var a=Number(M("DCLKSTAT",0));return isNaN(a)?0:a}
...
yv(this,e,d,a.program,b,c)}else Gr(Error("Cannot initialize botguard without program"))};
function yv(a,b,c,d,e,f){var g=void 0===g?"trayride":g;c?(a.state=2,kv(c,function(){window[g]?zv(a,d,g,e):(a.state=3,pv(c),Gr(new S("Unable to load Botguard","from "+c)))},f)):b?(f=ef("SCRIPT"),f.textContent=b,f.nonce=ic(),document.head.appendChild(f),document.head.removeChild(f),window[g]?zv(a,d,g,e):(a.state=4,Gr(new S("Unable to load Botguard from JS")))):Gr(new S("Unable to load VM; no url or JS provided"))}
xv.prototype.isInitialized=function(){return!!this.i};
function zv(a,b,c,d){a.state=5;try{var e=new xh({program:b,globalName:c});e.hd.then(function(){a.state=6;d&&d(b)});
Av(a,e)}catch(f){a.state=7,f instanceof Error&&Gr(f)}}
xv.prototype.invoke=function(a){a=void 0===a?{}:a;var b=this.i;if(b){var c={Mb:a};if(b.Wa)throw Error("Already disposed");a=vh();var d;null!=(d=b.sa)&&d.j.i.Cb("/client_streamz/bg/fsc",d.Aa);d=b.md([c.Mb,c.kd]);null!=(b=b.sa)&&(a=vh()-a,b.l.i.hb("/client_streamz/bg/fsl",a,b.Aa));b=d}else b=null;return b};
xv.prototype.dispose=function(){Av(this,null);this.state=8};
function Av(a,b){ne(a.i);a.i=b}
...
e=Ql(d,Fv(this,a.Ca));this.i[a.Na]=Object.assign({},a.Ca,{tb:d,Za:e})}}
...
Hv.prototype.install=function(){this.plugins.push.apply(this.plugins,ia(Ma.apply(0,arguments)))};
...
function Iv(a,b,c){return function(){var d=Ma.apply(0,arguments),e=b.filter(function(k){var m;return 10===(null!=(m=null!=c?c:k.priority)?m:0)}),f=b.filter(function(k){var m;
...
t(Kv,Hv);Kv.prototype.j=function(a,b){a(null==b?void 0:b.event);P("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_foregrounded")};
Kv.prototype.i=function(a,b){a(null==b?void 0:b.event);P("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_backgrounded")};
...
Lv.prototype.install=function(){var a=Ma.apply(0,arguments);this.i.install.apply(this.i,ia(a));this.j.install.apply(this.j,ia(a))};function Mv(){Lv.call(this);var a={};this.install((a.document_disposed={callback:this.l},a));a={};this.install((a.flush_logs={callback:this.m},a))}
var Nv;t(Mv,Lv);Mv.prototype.m=function(){if(P("web_fp_via_jspb")){var a=new gj,b=Yr();b&&a.V(b);b=new Ij;Xd(b,gj,380,Jj,a);fr(b);P("web_fp_via_jspb_and_json")&&em("finalPayload",{csn:Yr()})}else em("finalPayload",{csn:Yr()})};
Mv.prototype.l=function(){Kr(Lr)};function Ov(){}
...
z("ytglobal.storageClass_",Ov);function cm(a,b){var c=this;this.handleError=a;this.i=b;this.j=!1;void 0===self.document||self.addEventListener("beforeunload",function(){c.j=!0});
...
;function Sv(a,b,c){J.call(this);var d=this;c=c||M("POST_MESSAGE_ORIGIN")||window.document.location.protocol+"//"+window.document.location.hostname;this.l=b||null;this.targetOrigin="*";this.m=c;this.sessionId=null;this.channel="widget";this.F=!!a;this.v=function(e){a:if(!("*"!=d.m&&e.origin!=d.m||d.l&&e.source!=d.l||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.F&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
t(Sv,J);Sv.prototype.sendMessage=function(a,b){if(b=b||this.l){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.targetOrigin)}catch(d){zk(d)}}};
Sv.prototype.C=function(){window.removeEventListener("message",this.v);J.prototype.C.call(this)};function Tv(){this.j=[];this.isReady=!1;this.l={};var a=this.i=new Sv(!!M("WIDGET_ID_ENFORCE")),b=this.Uc.bind(this);a.o=b;a.s=null;this.i.channel="widget";if(a=M("WIDGET_ID"))this.i.sessionId=a}
l=Tv.prototype;l.Uc=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.l[a]||"onReady"===a||(this.addEventListener(a,Uv(this,a)),this.l[a]=!0)):this.Db(a,b,c)};
l.Db=function(){};
...
function Yv(a,b,c,d){if(Ta(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
...
l.Db=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Wv(a)){var d=b;if(Ta(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=Xv(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
...
l.dispose=function(){Tv.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function $v(a){J.call(this);this.j={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.cc,this)}
...
l.C=function(){var a=this.connection;a.i()||oi(a.j,"command",this.cc,this);this.connection=null;for(var b in this.j)this.j.hasOwnProperty(b)&&this.removeListener(b);J.prototype.C.call(this)};function cw(a,b){$v.call(this,b);this.api=a;this.start()}
...
cw.prototype.C=function(){$v.prototype.C.call(this);delete this.api};function dw(a){a=void 0===a?!1:a;J.call(this);this.j=new L(a);pe(this,this.j)}
ab(dw,J);dw.prototype.subscribe=function(a,b,c){return this.i()?0:this.j.subscribe(a,b,c)};
...
ew.prototype.C=function(){this.destination=this.l=null;dw.prototype.C.call(this)};function fw(a,b,c){J.call(this);this.destination=a;this.origin=c;this.j=$p(window,"message",this.l.bind(this));this.connection=new ew(this,a,b);pe(this,this.connection)}
t(fw,J);fw.prototype.va=function(a,b,c,d){this.i()||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(tg(a),this.origin))};
...
fw.prototype.C=function(){aq(this.j);this.destination=null;J.prototype.C.call(this)};function gw(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||vb(b);this.assets=a.assets||{};this.attrs=a.attrs||vb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
gw.prototype.clone=function(){var a=new gw,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Ra(c)?a[b]=vb(c):a[b]=c}return a};var hw=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function iw(a){a=a||"";if(window.spf){var b=a.match(hw);spf.style.load(a,b?b[1]:"",void 0)}else jw(a)}
function jw(a){var b=kw(a),c=document.getElementById(b),d=c&&gv(c,"loaded");d||c&&!d||(c=lw(a,b,function(){gv(c,"loaded")||(ev(c),pq(b),Sk($a(qq,b),0))}))}
...
function kw(a){var b=ef("A");Fb("This URL is never added to the DOM");fc(b,new Ob(a,Pb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+kc(a)}
...
t(nw,mw);function ow(a,b,c,d){J.call(this);var e=this;this.v=b;this.webPlayerContextConfig=d;this.da=!1;this.api={};this.W=this.s=null;this.K=new L;this.j={};this.R=this.X=this.elementId=this.qa=this.config=null;this.P=!1;this.m=this.F=null;this.ka={};this.Pa=["onReady"];this.lastError=null;this.Ea=NaN;this.J={};this.Qa=new nw(this);this.T=0;this.l=this.o=a;pe(this,this.K);pw(this);qw(this);pe(this,this.Qa);c?this.T=Sk(function(){e.loadNewVideoConfig(c)},0):d&&(rw(this),sw(this))}
t(ow,J);l=ow.prototype;l.getId=function(){return this.v};
l.loadNewVideoConfig=function(a){if(!this.i()){this.T&&(Tk(this.T),this.T=0);var b=a||{};b instanceof gw||(b=new gw(b));this.config=b;this.setConfig(a);sw(this);this.isReady()&&tw(this)}};
...
function xw(a){var b=df(a.elementId);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.elementId));return b}
function zw(a){if(!a.i()){var b=xw(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);if(c){a.P=!1;if(!Bw(a,"html5_remove_not_servable_check_killswitch")){var d;if((null==b?0:b.isNotServable)&&a.config&&(null==b?0:b.isNotServable(null==(d=a.config.args)?void 0:d.video_id)))return}Ew(a)}else a.Ea=Sk(function(){zw(a)},50)}}
...
function Fw(a,b,c){var d=b[c];return function(){var e=Ma.apply(0,arguments);try{return a.lastError=null,d.apply(b,e)}catch(f){"sendAbandonmentPing"!==c&&(f.params=c,a.lastError=f,Gr(f))}}}
function pw(a){a.da=!1;if(a.W)for(var b in a.j)a.j.hasOwnProperty(b)&&a.W(b,a.j[b]);for(var c in a.J)a.J.hasOwnProperty(c)&&Tk(Number(c));a.J={};a.s=null;a.W=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function qw(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){pq("WATCH_LATER_VIDEO_ADDED",b)});
a.addEventListener("WATCH_LATER_VIDEO_REMOVED",function(b){pq("WATCH_LATER_VIDEO_REMOVED",b)})}
l.addEventListener=function(a,b){var c=this,d=vw(this,b);d&&(0<=gb(this.Pa,a)||this.j[a]||(b=Gw(this,a),this.s&&this.s(a,b)),this.K.subscribe(a,d),"onReady"===a&&this.isReady()&&Sk(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.i()||(b=vw(this,b))&&oi(this.K,a,b)};
function vw(a,b){var c=b;if("string"===typeof b){if(a.ka[b])return a.ka[b];c=function(){var d=Ma.apply(0,arguments),e=B(b);if(e)try{e.apply(y,d)}catch(f){Fr(f)}};
a.ka[b]=c}return c?c:null}
function Gw(a,b){var c="ytPlayer"+b+a.v;a.j[b]=c;y[c]=function(d){var e=Sk(function(){if(!a.i()){try{a.K.oa(b,null!=d?d:void 0)}catch(h){Gr(new S("PlayerProxy error when creating global callback",{error:h,event:b,playerId:a.v,data:d}))}var f=a.J,g=String(e);g in f&&delete f[g]}},0);
sb(a.J,String(e))};
return c}
...
l.cancel=function(){this.F&&qv(yw(this),this.F);Tk(this.Ea);this.P=!1};
l.C=function(){Aw(this);if(this.m&&this.config&&this.m.destroy)try{this.m.destroy()}catch(b){Fr(b)}this.ka=null;for(var a in this.j)this.j.hasOwnProperty(a)&&(y[this.j[a]]=null);this.qa=this.config=this.api=null;delete this.o;delete this.l;J.prototype.C.call(this)};
...
function Bw(a,b){if(a.webPlayerContextConfig)var c=a.webPlayerContextConfig.serializedExperimentFlags;else{var d;if(null==(d=a.config)?0:d.args)c=a.config.args.fflags}return"true"===Fk(c||"","&")[b]}
function uw(a){for(var b={},c=p(Object.keys(a)),d=c.next();!d.done;d=c.next()){d=d.value;var e=a[d];b[d]="object"===typeof e?vb(e):e}return b}
;var Hw={},Iw="player_uid_"+(1E9*Math.random()>>>0);function Jw(a,b,c){var d="player";c=void 0===c?!0:c;d="string"===typeof d?df(d):d;var e=Iw+"_"+Ua(d),f=Hw[e];if(f&&c)return Kw(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new ow(d,e,a,b);Hw[e]=f;pq("player-added",f.api);qe(f,function(){delete Hw[f.getId()]});
return f.api}
...
;function Rw(a,b,c){a="ST-"+kc(a).toString(36);b=b?tc(b):"";c=c||5;ms()&&il(a,b,c)}
;function Sw(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=M("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=M("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=oc(window.location.href);g&&f.push(g);g=oc(d);if(0<=gb(f,g)||!g&&0==d.lastIndexOf("/",0))if(P("autoescape_tempdata_url")&&(f=document.createElement("a"),fc(f,d),d=f.href),d&&(d=pc(d),f=d.indexOf("#"),d=0>f?d:d.slice(0,f)))if(e&&!b.csn&&(b.itct||b.ved)&&(b=Object.assign({csn:Yr()},b)),h){var h=parseInt(h,10);isFinite(h)&&0<h&&
Rw(d,b,h)}else Rw(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=yc(a,k)+m;var r=void 0===r?Ih:r;a:{r=void 0===r?Ih:r;for(k=0;k<r.length;++k)if(m=r[k],m instanceof Gh&&m.isValid(a)){r=new Ob(a,Pb);break a}r=void 0}c.href=Qb(r||Sb)}return!0}
;z("yt.setConfig",pk);z("yt.config.set",pk);z("yt.setMsg",cs);z("yt.msgs.set",cs);z("yt.logging.errors.log",Fr);
z("writeEmbed",function(){var a=M("PLAYER_CONFIG");if(!a){var b=M("PLAYER_VARS");b&&(a={args:b})}vs(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=M("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);P("embeds_js_api_set_1p_cookie")&&(c=Kk(window.location.href),c.embedsTokenValue&&(a.args.embedsTokenValue=c.embedsTokenValue));Vt();if((c=M("WEB_PLAYER_CONTEXT_CONFIGS"))&&
"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c){c=c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;if(!c.serializedForcedExperimentIds){var d=Kk(window.location.href);d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}Lw=Jw(a,c,!1)}else Lw=Jw(a);Lw.addEventListener("onVideoDataChange",Ow);Lw.addEventListener("onReady",Qw);a=M("POST_MESSAGE_ID","player");M("ENABLE_JS_API")?Nw=new Zv(Lw):M("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(Mw=new fw(window.parent,
a,b),Nw=new cw(Lw,Mw.connection));tv();P("ytidb_create_logger_embed_killswitch")||bm();a={};Nv||(Nv=new Mv);Nv.install((a.flush_logs={callback:function(){Hq()}},a));
P("embeds_web_enable_new_nwl")?Ko():So();P("ytidb_clear_embedded_player")&&Qh.S(function(){var e;if(!Du){var f=Gs(),g={xb:Cu,mc:Bu};f.providers.set(g.xb,g);g={Lb:{feedbackEndpoint:Rs(xu),modifyChannelNotificationPreferenceEndpoint:Rs(yu),playlistEditEndpoint:Rs(zu),subscribeEndpoint:Rs(vu),unsubscribeEndpoint:Rs(wu),webPlayerShareEntityServiceEndpoint:Rs(Au)}};var h=P("web_enable_client_location_service")?Ns.getInstance():void 0,k={};h&&(k.client_location=h);if(void 0===m){ws.i||(ws.i=new ws);var m=
ws.i}void 0===e&&(e=f.resolve(Cu));ju(g,e,m,k);m={xb:ou,nc:iu.i};f.providers.set(m.xb,m);Du=iu.i}dv()})});
var Tw=xk(function(){$t();var a=ll.getInstance(),b=ol(119),c=1<window.devicePixelRatio;if(document.body&&bi(document.body,"exp-invert-logo"))if(c&&!bi(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!bi(d,"inverted-hdpi")){var e=$h(d);ai(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&bi(document.body,"inverted-hdpi")&&ci();if(b!=c){b="f"+(Math.floor(119/31)+1);d=pl(b)||0;d=c?d|67108864:d&-67108865;0==d?delete kl[b]:(c=d.toString(16),
kl[b]=c.toString());c=!0;P("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.i;d=[];for(var f in kl)d.push(f+"="+encodeURIComponent(String(kl[f])));il(b,d.join("&"),63072E3,a.j,c)}Nu.i||(Nu.i=new Nu);a=Nu.i;f=16623;var g=void 0===g?{}:g;Object.values(ds).includes(f)||(Gr(new S("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.i.push({rootVe:f,key:g.key||""});a.o=[];a.N=[];g.Ob?Qu(a,f,g):Ru(a,f,g)}),Uw=xk(function(){Lw&&Lw.sendAbandonmentPing&&Lw.sendAbandonmentPing();
M("PL_ATT")&&Bv.dispose();for(var a=Qh,b=0,c=rv.length;b<c;b++)a.fa(rv[b]);rv.length=0;pv("//static.doubleclick.net/instream/ad_status.js");sv=!1;pk("DCLKSTAT",0);oe(Nw,Mw);Lw&&(Lw.removeEventListener("onVideoDataChange",Ow),Lw.destroy())});
window.addEventListener?(window.addEventListener("load",Tw),window.addEventListener("pagehide",Uw)):window.attachEvent&&(window.attachEvent("onload",Tw),window.attachEvent("onunload",Uw));z("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Cv);z("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||Dv);z("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||wv);z("yt.player.exports.navigate",B("yt.player.exports.navigate")||Sw);
